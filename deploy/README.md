...
OCC contract with sufficient quantity from the broker. One logical hedge reduction
may use multiple exact held OCC puts, but cannot place an equity/core-book order,
a batch of independent actions, or close income structures autonomously. Before every write it records autonomous-policy provenance,
